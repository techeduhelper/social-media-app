        ...
        <div className="w-full">
          <div className="bg-white w-full mb-10">
            <div className="lg:w-1/2 mx-auto">
              <div className="bg-white rounded-t-lg p-10">
              ...
              <div className="bg-gray-100 rounded-b-lg py-12 sm:px-4 lg:px-24 shadow-sm mx-4">
                ...
                <form className="mt-6">
                  ...
                  <div className="flex items-center justify-center mt-8">
                    <button className="text-white py-2 px-4 uppercase rounded-full bg-green-600 hover:bg-green-700 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5 w-full">
                      Create Account
                    </button>
                  </div>
                </form>
