...
import { isPasswordStrong } from "../utils/strengthPassword.js";
...
const Register = () => {
  ...
  const passwordStrengthCheck = (e) => {
    const receivedPassword = e.target.value;
    setPassword(receivedPassword);

    const strength = isPasswordStrong(receivedPassword) ? "strong" : "weak";
        ...
        <div className="w-full">
          <div className="bg-white w-full mb-10">
            <div className="lg:w-1/2 mx-auto">
              <div className="bg-white rounded-t-lg mb-4 pt-2">
              ...
              <div className="bg-gray-100 rounded-b-lg py-12 sm:px-4 lg:px-24 shadow-sm mx-4">
                ...
                <form className="mt-6">
                  ...
                  {password && (
                    ...
                    >
                      Password is too {passwordStrength}
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-center mt-8">
                    <button
                      ...
                      // disabled={!name || !username || !password || !mobno}
                      className="text-white py-2 px-4 uppercase rounded-full bg-green-600 hover:bg-green-700 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5 w-full"
                    >
                      Create Account
                    </button>
                  </div>
